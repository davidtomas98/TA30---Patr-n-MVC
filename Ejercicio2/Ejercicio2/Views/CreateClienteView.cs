...
{
    internal class CreateClienteView : Form
    {
        ...
        public CreateClienteView(ClienteController clienteController)
        {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "CreateClienteView";
            this.Load += new System.EventHandler(this.CreateClienteView_Load);
            this.ResumeLayout(false);

        }

        private void CreateClienteView_Load(object sender, EventArgs e)
        {
